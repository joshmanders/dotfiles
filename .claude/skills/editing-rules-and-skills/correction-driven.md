...
The frustration that prompted it happened **somewhere else** — a different project or session where Claude misbehaved badly enough that Josh now wants the lesson encoded. The incident is in his head, not in your loaded context.

- "I don't see an incident in my context, so there isn't one" is wrong. Ask Josh what happened.
- Don't invent the incident, don't paraphrase a vague feeling — ask for the actual story.

Acceptable when there's no specific incident:
...
- A concrete cost ("the cost of confirming is one round trip; the cost of the wrong action can be catastrophic — lost work, rewritten history, leaked secrets")
...
Semantics are fixed unless Josh explicitly updates them. Voice changes; substance does not. If you want to soften, tighten, or expand a lesson mid-rewrite, that's a separate conversation — stop and ask.
